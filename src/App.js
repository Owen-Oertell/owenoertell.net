...
function App() {
  return (
    <div className="App">
      ...
      <div className='text'>
        <p className='info'>I am an incoming freshmen at Cornell University, double majoring in computer science and electrical and computer engineering, with a double minor in applied mathematics and economics.</p>
